...
class StreamCreate extends React.Component {
  ...
  _renderInput = (formProps) => {
    ...
    //formProps -->  {label:'', meta:{touched: false, valid: false, visited: true, error: "You must enter a title"}, input: { name: ''}}
  ...
  render(){
    ...
    return (
      <div className="ui container">
          <form className="ui form error" onSubmit={this.props.handleSubmit(this._onSubmit)}>
